<template>
  <div>
    <v-navigation-drawer persistent :mini-variant="miniDrawer" v-model="showDrawer" fixed app class="nav">
      <v-layout column fill-height>
        <v-list>
          ...
          <v-list-tile to="/main/stores" class="tile">
            <v-list-tile-action>
              <v-icon>store</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
        ...
        <v-list subheader v-show="hasAdminAccess">
          ...
          <v-list-tile to="/main/admin/users/all" class="tile">
            <v-list-tile-action>
              <v-icon>group</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
...
import { readDashboardMiniDrawer, readDashboardShowDrawer, readHasAdminAccess, readToken } from '@/store/main/getters';
